...
colors = {'Proton - Solar wind': 'red', 'Electron - Solar wind': 'blue'}
...
def create_figure():
    augment = 0.02
    inch = 0.0254
    DX = (c.XMAX-c.XMIN)/inch*augment
    DY = (c.YMAX-c.YMIN)/inch*augment
    dx = (c.XMAX-c.XMIN)/(c.NX-1)
    dy = (c.YMAX-c.YMIN)/(c.NY-1)
